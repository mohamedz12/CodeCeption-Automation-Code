...
public class CodeCeptionTests extends BaseTests {
    Utilities ut=new Utilities();
	 ...
	 public void C_Update_Status() throws InterruptedException, AWTException, IOException {
		 ...
		 Thread.sleep(2000);
		 ut.UploadFile("C:\\Test Artifacts\\Image_1.jpg");
		 Thread.sleep(2000);
	 ...
	 public void D_CreateAlbum_UploadMedia() throws InterruptedException, AWTException, IOException {
		 ...
		 Thread.sleep(2000);
		 ut.UploadFile("C:\\Test Artifacts\\Image_2.jpg");
		 Thread.sleep(2000);
		 driver.findElement(By.id("rtMedia-upload-button")).click();
		 Thread.sleep(2000);
		 ut.UploadFile("C:\\Test Artifacts\\Image_3.jpg");
		 Thread.sleep(2000);
		 driver.findElement(By.id("rtMedia-upload-button")).click();
		 Thread.sleep(2000);
		 ut.UploadFile("C:\\Test Artifacts\\Image_4.jpg");
		 Thread.sleep(2000);
		 driver.findElement(By.id("rtMedia-upload-button")).click();
		 Thread.sleep(2000);
		 ut.UploadFile("C:\\Test Artifacts\\Image_5.jpg");
		 Thread.sleep(2000);
		 driver.findElement(By.id("rtMedia-upload-button")).click();
		 Thread.sleep(2000);
		 ut.UploadFile("C:\\Test Artifacts\\Image_6.jpg");
		 Thread.sleep(2000);
	 ...
	 public void E_Change_Cover_Image() throws InterruptedException, IOException, AWTException {
		 ...
		 Thread.sleep(3000);
		 ut.UploadFile("C:\\Test Artifacts\\Profile pic.jpg");
		 Thread.sleep(8000);
